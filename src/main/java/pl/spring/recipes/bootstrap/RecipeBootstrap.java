package pl.spring.recipes.bootstrap;
...
import pl.spring.recipes.domain.*;
import pl.spring.recipes.repositories.CategoryRepository;
import pl.spring.recipes.repositories.RecipeRepository;
import pl.spring.recipes.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.addIngredient(new Ingredient("boneless chicken thighs", new BigDecimal(4),
                eachUom));
        tacosRecipe.addIngredient(new Ingredient("small corn tortillas", new BigDecimal(8),
                eachUom));
